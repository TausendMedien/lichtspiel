...
export const hyperMixHeat: Pattern = {
  ...
  controls: [
    ...
    },
    {
      ...
      tip: "How strongly the heat map deforms the particle cloud. Requires Heat.",
    ...
    },
    {
      ...
      default: 11.0,
      interactive: 'heat' as const,
      tip: "Amplify the heat signal — higher = reacts to subtler motion.",
      get: () => params.heatGain,
    ...
    },
    {
      ...
      default: 2,
      interactive: 'heat' as const,
      tip: "Blur applied to the heat map before driving the pattern. Smoother effect, slightly heavier.",
      get: () => blurRadius,
      set: (v) => { blurRadius = v; },
    },
  ],
  ...
  update(dt: number, _elapsed: number) {
    ...
    if (heatOrPushActive()) {
      ...
      material.uniforms.uHeatStrength.value = cameraState.heatEnabled ? params.heatStrength : 0;
