...
export type PatternControl =
  | { label: string; type: "range"; min: number; max: number; step: number; default?: number; readonly?: boolean; disabled?: () => boolean; interactive?: 'pose' | 'camera' | 'internal'; audioWeight?: number; exp?: true; get(): number; set(v: number): void }
